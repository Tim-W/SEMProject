...
public abstract class Unit {
	...
	public boolean intersect(Unit collidee) {
		if (this instanceof Qix) {
			...
			Rectangle collideeR = new Rectangle(collidee.getX(), collidee.getY(), collidee.getWidth() / 2 - 1,
		...
		if (collidee instanceof Qix) {
			...
			// subtract one from width&height to make collisions look more real
			Rectangle colliderR = new Rectangle(this.getX(), this.getY(), this.getWidth() / 2 - 1,
					this.getHeight() / 2 - 1);
