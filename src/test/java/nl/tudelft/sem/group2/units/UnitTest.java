...
public class UnitTest {
    ...
    public void intersectUnitUnit() throws Exception {
        Cursor concreteUnit = new Cursor(new Point(1, 1), 5, 5, areaTracker, mock(Stix.class), 3, 1);
        Cursor concreteUnit2 = new Cursor(new Point(1, 1), 5, 5, areaTracker, mock(Stix.class), 3, 1);
    ...
    public void intersectNotUnitUnit() throws Exception {
        Cursor concreteUnit = new Cursor(new Point(1, 1), 5, 5, areaTracker, mock(Stix.class), 3, 1);
        Cursor concreteUnit2 = new Cursor(new Point(20, 20), 5, 5, areaTracker, mock(Stix.class), 3, 1);
    ...
    public void intersectFuseCursor() throws Exception {
        ...
        Cursor cursor = spy(new Cursor(new Point(1, 1), 5, 5, areaTracker, stix, 1, 1));
