...
public class GameControllerTest {
    ...
    public void keyPressedArrow() throws Exception {
        Cursor cursor = new Cursor(1, 1, 1, 1, GameController.getInstance().getAreaTracker(), new Stix(), Color.RED);
    ...
    public void keyPressedX() throws Exception {
        ...
        Cursor cursor = spy(new Cursor(1, 1, 1, 1, GameController.getInstance().getAreaTracker(), new Stix(), Color.RED));
    ...
    public void keyPressedXNotFast() throws Exception {
        ...
        Cursor cursor = spy(new Cursor(1, 1, 1, 1, gameController.getAreaTracker(), stix, Color.RED));
        gameController.addCursor(cursor);
    ...
    public void keyPressedXNotFastNothing() throws Exception {
        Stix stix = new Stix();
        stix.addToStix(new Point(1, 1));
        Cursor cursor = spy(new Cursor(1, 1, 1, 1, GameController.getInstance().getAreaTracker(), stix, Color.RED));
        gameController.addCursor(cursor);
        cursor.setFast(true);
        gameController.keyPressed(new KeyEvent(null, null, KeyEvent.KEY_PRESSED, " ", "", KeyCode.O, false, false,
                false, false));
